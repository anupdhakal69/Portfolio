  ...
  return (
    ...
    <div className='px-2 max-w-[400px] flex flex-col gap-5 items-center justify-center sm:max-w-[900px]  mx-auto h-[calc(100vh-80px)]'>
        ...
        <div className='flex flex-col gap-4'> 
          <h1 className='text-[35px] sm:text-4xl md:text-6xl text-center font-semibold md:font-medium leading-tight'> <span className='text-teal-600 herospan'>I'm Anup Dhakal,</span> full stack developer based in USA.</h1>
