  ...
  return (
    ...
    <div className='px-2 mt-8 max-w-[400px] flex flex-col gap-5 items-center sm:max-w-[920px]  mx-auto h-full'>
        ...
        <div className='flex flex-col gap-4'>
          <h1 className='text-[35px] sm:text-4xl md:text-6xl text-center font-semibold leading-10'> <span className='text-teal-600'>I'm Anup Dhakal,</span> full stack developer based in USA.</h1>
